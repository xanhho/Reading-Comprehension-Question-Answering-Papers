...
- Patrick Lewis et al., **Unsupervised Question Answering by Cloze Translation**, ACL 2019, [paper](https://www.aclweb.org/anthology/P19-1484.pdf). (<span style="color:orange;">Unsupervised Model</span>) (<div class="text-orange mb-2">
